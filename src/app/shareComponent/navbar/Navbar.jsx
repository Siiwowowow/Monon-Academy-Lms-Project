    ...
    <>
      <nav className={`navbar sticky top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="navbar-start">
          ...
          <Link
            href="/"
            className="btn btn-ghost text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hover:scale-105 transition-transform"
          >
        ...
        <div className="navbar-end gap-3 hidden lg:flex">
          ...
          {/* Notifications */}
          {user && (
            <button className="btn btn-ghost btn-circle relative text-gray-600 hover:text-blue-600 hover:bg-gray-100/50 rounded-2xl">
          ...
          {user ? (
            <div className="relative" ref={dropdownRef}>
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 top-full mt-3 w-72 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-100/50 overflow-hidden animate-fadeIn">
                  {/* User Info */}
                  <div className="p-6 bg-gradient-to-r from-blue-50 to-purple-50 border-b border-gray-100/50">
            ...
            <div className="flex items-center gap-2">
              <Link
                href="/login"
                className="btn btn-ghost text-gray-600 hover:text-blue-600 hover:bg-gray-100/50 rounded-2xl font-medium transition-all"
              >
              ...
              <Link
                href="/signUp"
                className="btn bg-gradient-to-r from-blue-500 to-purple-500 text-white hover:from-blue-600 hover:to-purple-600 rounded-2xl font-medium shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 transition-all"
              >
        ...
        <div className="navbar-end lg:hidden flex items-center gap-2">
          ...
          {user ? (
            ...
            <div className="dropdown dropdown-end">
              ...
              >
                <li className="p-4 border-b border-gray-100/50">
            ...
            // Mobile Login Icon
            <Link href="/login" className="btn btn-ghost btn-circle text-gray-600">
      ...
      >
        ...
        <div className="p-6 h-[calc(100vh-80px)] overflow-y-auto">
          ...
          {user && (
            <div className="mb-8 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl border border-gray-100/50">
              <div className="flex items-center gap-4">
                <img
                  src={user.photoURL || "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=48&h=48&fit=crop&crop=face"}
                  className="w-14 h-14 rounded-full border-2 border-white shadow-lg"
          ...
          {user ? (
            ...
            <div className="space-y-3">
              ...
              <Link
                href="/signUp"
                className="btn w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white hover:from-blue-600 hover:to-purple-600 rounded-2xl font-medium shadow-lg shadow-blue-500/25"
                onClick={() => setIsOpen(false)}
              >
                <FaUserPlus className="mr-2" />
                Get Started
          ...
          {/* Footer Section */}
          <div className="mt-8 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl border border-gray-100/50">
